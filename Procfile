...
web: gunicorn hystocks.settings.wsgi -b 0.0.0.0:8002 -c "gunicorn.conf.py" # --access-logfile "/var/log/gunicorn-acess.log" --error-logfile "/var/log/gunicorn-error.log"
